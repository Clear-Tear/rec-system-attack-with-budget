...
from sur_model.utility.Logging import Logging
import sur_model.utility.config as config
from sur_model.utility.model_multi import NCF
from sur_model.utility.data_utils import NCFData
from sur_model.utility.batch_test import rec_test
from sur_model.utility.gpuutil import trans_to_cuda
from sur_model.utility2.utils import Data
from sur_model.utility2.gnn_batch_test import trust_test5
...
def trainmodel(args,train_loader, testRatings, testNegatives, user_num, item_num, train_mat,k):
    ...
    for epoch in range(args.epochs):
        ...
        for data in train_loader:
            ...
            rec_prediction, trust_scores, trust_targets = model(useritem=trans_to_cuda(useritem.T), slice_indices=slice_indices, trust_data=train_data2, flag=0)
