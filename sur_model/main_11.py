...
def trainmodel(args, train_data, testRatings, testNegatives, user_num, item_num, train_mat, k):
    ...
    for epoch in range(args.epochs):
        ...
        train_time = t1 - t0
        print("train successfully, time:{}".format(train_time))
        print("----------------")
        model.eval()
        # rec
